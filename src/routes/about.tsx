...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "OG Star Travel about us, travel agency Accra, travel company Ghana, trusted travel agent Ghana, visa consultancy Accra, work abroad company Ghana" },
      ...
      { property: "og:url", content: "https://ogstartravelandtours.com/about" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: `https://ogstartravelandtours.com${heroImg}` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "About — OG Star Travel & Tours" },
      { name: "twitter:description", content: "A concierge-grade international mobility brand from Ghana." },
      { name: "twitter:image", content: `https://ogstartravelandtours.com${heroImg}` },
    ],
    links: [{ rel: "canonical", href: "https://ogstartravelandtours.com/about" }],
  }),
  component: AboutPage,
});
