...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "travel agency services Ghana, visa support Accra, work abroad services Ghana, flight booking Ghana, relocation support Ghana, interview coaching Ghana, travel documentation Accra, tour packages Ghana" },
      { property: "og:title", content: "Services — OG Star Travel & Tour" },
      { property: "og:description", content: "A concierge for every stage of your international journey." },
      { property: "og:url", content: "https://ogstartravelandtours.com/services" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: `https://ogstartravelandtours.com${heroImg}` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Services — OG Star Travel & Tour" },
      { name: "twitter:description", content: "A concierge for every stage of your international journey." },
      { name: "twitter:image", content: `https://ogstartravelandtours.com${heroImg}` },
    ],
    links: [{ rel: "canonical", href: "https://ogstartravelandtours.com/services" }],
  }),
