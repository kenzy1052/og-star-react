...
export const Route = createFileRoute("/local-tours")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "local tours Ghana, Cape Coast tours, Elmina Castle tours, Mole National Park safari, Wli Waterfalls tour, Ashanti Kingdom tour, Kumasi tours, Accra day tours, Nzulezu tours, Ghana travel packages" },
      ...
      { property: "og:url", content: "https://ogstartravelandtours.com/local-tours" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: `https://ogstartravelandtours.com${heroImg}` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Local Tours — OG Star Travel & Tours" },
      { name: "twitter:description", content: "Ghana, told slowly. Curated journeys with concierge care." },
      { name: "twitter:image", content: `https://ogstartravelandtours.com${heroImg}` },
    ],
    links: [{ rel: "canonical", href: "https://ogstartravelandtours.com/local-tours" }],
  }),
