...
export const Route = createFileRoute("/international")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "international tours Ghana, Dubai tours from Ghana, Morocco tours, Bali tours, Istanbul tours, Europe tours from Accra, international travel agency Ghana, holiday packages Ghana" },
      ...
      { property: "og:url", content: "https://ogstartravelandtours.com/international" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: `https://ogstartravelandtours.com${heroImg}` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "International Tours — OG Star Travel & Tours" },
      { name: "twitter:description", content: "A small atlas of the world, considered. Curated international journeys from Accra." },
      { name: "twitter:image", content: `https://ogstartravelandtours.com${heroImg}` },
    ],
    links: [{ rel: "canonical", href: "https://ogstartravelandtours.com/international" }],
  }),
